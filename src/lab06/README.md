...
src/
├── lab01/
│   └── model.py      # Классы студентов с добавленными аннотациями типов
└── lab06/
    ├── container.py   # Обобщённый контейнер и протоколы
...
### 3.3. Протоколы и ограниченные коллекции (5 баллов)
